...
// Executor against a never-connected ward: every MAVSDK-backed command
...
protected:
    CommandExecutorTest()
        : core_(WardConnection::create_shared_core()),
          ward_(core_, "udpin://127.0.0.1:24990"),
          actions_(ward_),
          telemetry_(ward_),
          mission_(ward_),
...
TEST_F(CommandExecutorTest, AckEchoesCommandAndWardIds) {
