 ...
 * adsbOne.ts's own mapping comment for the full code-to-bucket table. */
...
export interface Aircraft {
	...
	/** Tail number (e.g. "PH-BHA") - adsb.one has no nationality
	...
	/** Owner/operator name (e.g. "KLM Royal Dutch Airlines") - adsb.one's
	 ...
	 * adsb.one's own database, not a guess from callsign/registration
	 * patterns. */
	isMilitary: boolean;
