 ...
 * adsbLolProxy.ts's own mapping comment for the full code-to-bucket table. */
...
export interface Aircraft {
	...
	/** Tail number (e.g. "PH-BHA") - the feed has no nationality
	...
	/** Owner/operator name (e.g. "KLM Royal Dutch Airlines") - the feed's
	 ...
	 * the feed's own database, not a guess from callsign/registration
	 * patterns. */
	isMilitary: boolean;
